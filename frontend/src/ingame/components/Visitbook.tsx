...
import CreateIcon from '@material-ui/icons/Create';interface IguestInfo {
  book: {
    ...
    <Wrapper>
      ...
      <Header>
        ...
        <div className="updateBtn">
          {clickModify ? (
            <div onClick={() => {  PutApi.mutate();changeModify()}}>
              저장
            </div>
          ) : (
      ...
      <img
        ...
        alt='profile' src={writerInfo.userImgUrl}/>:
     <img
        className="profileimg"
        onError={imageOnErrorHandler}
        alt='profile' src='data:image/png;base64,'/>
        }
      {clickModify ? (
