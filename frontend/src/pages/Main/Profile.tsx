...
const Profile = () => {
  ...
  //   }
  // );
  // const getChar  = useMutation<any,Error>(
  //   "getCharacter",
  //   async () => {return (await getCharacter(Number(userId)))
  //     },
  //   {
  //   onSuccess:(res)=>{ 
  //     console.log('캐릭터 받음')
      ...
      <SubBanner>
        ...
        <TitleCardDiv>
          <div className="container1">
            <img
              id="profileImg"
              src={user?.userImgUrl||'data:image/png;base64,'}
              alt="사진오류"
        ...
        {user!==undefined ?
          ...
          <>
            <div className="bgm">
              <span className="small">로그인 하시면 메타마스크의 지갑이 연결됩니다.</span>
            </div>
          </>}
        </Wallet>
          {user!==undefined ? 
