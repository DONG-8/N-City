...
var index = require('../../../../node_modules/ws/index.js');
...
class WebSocketClient {
    ...
    raw(data, options, cb) {
        if (this.ref.readyState !== index.OPEN) {
            core.logger.warn('trying to send data to inactive client', this.sessionId);
            return;
        }
    ...
    close(code, data) {
        core.logger.warn('DEPRECATION WARNING: use client.leave() instead of client.close()');
        try {
            throw new Error();
        }
        catch (e) {
            core.logger.info(e.stack);
        }
...
//# sourceMappingURL=WebSocketClient.mjs.js.map
