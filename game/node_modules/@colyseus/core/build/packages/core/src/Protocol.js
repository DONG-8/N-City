...
const getMessageBytes = {
    [exports.Protocol.JOIN_ROOM]: (reconnectionToken, serializerId, handshake) => {
        let offset = 0;
    ...
    [exports.Protocol.ROOM_DATA_SCHEMA]: (message) => {
        ...
        if (typeid === undefined) {
            Logger.logger.warn('Starting at colyseus >= 0.13 You must provide a type and message when calling `this.broadcast()` or `client.send()`. Please see: https://docs.colyseus.io/migrating/0.13/');
