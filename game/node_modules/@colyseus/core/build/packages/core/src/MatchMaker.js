...
async function joinById(roomId, clientOptions = {}) {
    ...
    if (clientOptions.hasOwnProperty("reconnectionToken") &&
        clientOptions.hasOwnProperty("sessionId")) {
        ...
        if (sessionId) {
            ...
            throw new ServerError.ServerError(Protocol.ErrorCode.MATCHMAKE_EXPIRED, `session expired: ${sessionId}`);
        }
    }
    if (room.locked) {
