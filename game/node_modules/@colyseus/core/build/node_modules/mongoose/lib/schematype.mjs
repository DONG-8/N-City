...
import exists from './schema/operators/exists.mjs';
import type from './schema/operators/type.mjs';
import get from './helpers/get.mjs';
import handleImmutable from './helpers/schematype/handleImmutable.mjs';
import immediate from './helpers/immediate.mjs';
import symbols from './helpers/symbols.mjs';
import util from 'util';
import utils from './utils.mjs';

var schematype = createCommonjsModule(function (module, exports) {
...
const schemaTypeSymbol = symbols.schemaTypeSymbol;


const validatorErrorSymbol = symbols.validatorErrorSymbol;
...
function SchemaType(path, options, instance) {
  ...
  const Options = this.OptionsConstructor || SchemaTypeOptions_1;
...
SchemaType.prototype.OptionsConstructor = SchemaTypeOptions_1;
...
SchemaType.prototype.default = function(val) {
  if (arguments.length === 1) {
    ...
    if (val != null && val.instanceOfSchema) {
      throw new error('Cannot set default value of path `' + this.path +
...
SchemaType.prototype.validate = function(obj, message, type) {
  if (typeof obj === 'function' || obj && utils.getFunctionName(obj.constructor) === 'RegExp') {
    ...
    if (typeof message === 'function') {
      ...
      if (message == null) {
        message = error.messages.general.default;
      }
      if (!type) {
        type = 'user defined';
      }
...
SchemaType.prototype.required = function(required, message) {
  ...
  const msg = message || error.messages.general.required;
...
//# sourceMappingURL=schematype.mjs.map
