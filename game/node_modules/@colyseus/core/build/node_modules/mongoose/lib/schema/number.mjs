...
import SchemaNumberOptions_1 from '../options/SchemaNumberOptions.mjs';
import schematype from '../schematype.mjs';
import number$1 from '../cast/number.mjs';
import bitwise from './operators/bitwise.mjs';
...
SchemaNumber.prototype.OptionsConstructor = SchemaNumberOptions_1;
...
SchemaNumber.prototype.min = function(value, message) {
  ...
  if (value !== null && value !== undefined) {
    let msg = message || error.messages.Number.min;
...
SchemaNumber.prototype.max = function(value, message) {
  ...
  if (value !== null && value !== undefined) {
    let msg = message || error.messages.Number.max;
...
SchemaNumber.prototype.enum = function(values, message) {
  ...
  if (!Array.isArray(values)) {
    ...
    message = error.messages.Number.enum;
  }

  message = message == null ? error.messages.Number.enum : message;
...
SchemaNumber.prototype.$conditionalHandlers =
    utils.options(schematype.prototype.$conditionalHandlers, {
      $bitsAllClear: bitwise,
      $bitsAnyClear: bitwise,
      $bitsAllSet: bitwise,
      $bitsAnySet: bitwise,
      $gt: handleSingle,
      $gte: handleSingle,
