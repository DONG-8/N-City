...
import SchemaDateOptions_1 from '../options/SchemaDateOptions.mjs';
import schematype from '../schematype.mjs';
import date$1 from '../cast/date.mjs';
...
SchemaDate.prototype.OptionsConstructor = SchemaDateOptions_1;
...
SchemaDate.prototype.min = function(value, message) {
  ...
  if (value) {
    let msg = message || error.messages.Date.min;
...
SchemaDate.prototype.max = function(value, message) {
  ...
  if (value) {
    let msg = message || error.messages.Date.max;
    if (typeof msg === 'string') {
