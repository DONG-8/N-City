import cast from './error/cast.mjs';
import notFound from './error/notFound.mjs';
import kareem from '../../kareem/index.mjs';
import mongooseError from './error/mongooseError.mjs';
import objectParameter from './error/objectParameter.mjs';
import QueryCursor_1 from './cursor/QueryCursor.mjs';
import driver_1 from './driver.mjs';
import applyGlobalMaxTimeMS from './helpers/query/applyGlobalMaxTimeMS.mjs';
import applyWriteConcern from './helpers/schema/applyWriteConcern.mjs';
import cast$1 from './cast.mjs';
import castArrayFilters from './helpers/update/castArrayFilters.mjs';
import castUpdate from './helpers/query/castUpdate.mjs';
import completeMany_1 from './helpers/query/completeMany.mjs';
...
import hasDollarKeys from './helpers/query/hasDollarKeys.mjs';
...
import isInclusive from './helpers/projection/isInclusive.mjs';
import mquery from '../../mquery/lib/mquery.mjs';
import parseProjection from './helpers/projection/parseProjection.mjs';
import removeUnusedArrayFilters from './helpers/update/removeUnusedArrayFilters.mjs';
import sanitizeProjection$1 from './helpers/query/sanitizeProjection.mjs';
import selectPopulatedFields from './helpers/query/selectPopulatedFields.mjs';
import setDefaultsOnInsert from './helpers/setDefaultsOnInsert.mjs';
import sliced from '../../sliced/index.mjs';
import updateValidators from './helpers/updateValidators.mjs';
import util from 'util';
import utils from './utils.mjs';
import wrapThunk from './helpers/query/wrapThunk.mjs';
...
const ReadPreference = driver_1.get().ReadPreference;
...
const sanitizeProjection = sanitizeProjection$1;
...
Query.prototype._unsetCastError = function _unsetCastError() {
  if (this._error != null && !(this._error instanceof cast)) {
    return;
  }
  ...
  const cb = (err, docs) => {
    ...
    if (!mongooseOptions.populate) {
      return mongooseOptions.lean ?
        callback(null, docs) :
        completeMany_1(_this.model, docs, fields, userProvidedFields, completeManyOptions, callback);
    }

    const pop = queryhelpers.preparePopulationOptionsMQ(_this, mongooseOptions);
...
Query.prototype.find = function(conditions, callback) {
  ...
  if (mquery.canMerge(conditions)) {
    ...
    this.error(new objectParameter(conditions, 'filter', 'find'));
  }
...
Query.prototype._completeOne = function(doc, res, callback) {
  ...
  const pop = queryhelpers.preparePopulationOptionsMQ(this, this._mongooseOptions);
...
Query.prototype.findOne = function(conditions, projection, options, callback) {
  ...
  if (mquery.canMerge(conditions)) {
    ...
    this.error(new objectParameter(conditions, 'filter', 'findOne'));
  }
...
Query.prototype.distinct = function(field, conditions, callback) {
  ...
  if (mquery.canMerge(conditions)) {
    ...
    this.error(new objectParameter(conditions, 'filter', 'distinct'));
  }
...
Query.prototype.remove = function(filter, callback) {
  ...
  if (mquery.canMerge(filter)) {
    ...
    this.error(new objectParameter(filter, 'filter', 'remove'));
  }
...
Query.prototype._remove = wrapThunk(function(callback) {
  ...
  return Query.base.remove.call(this, queryhelpers.handleDeleteWriteOpResult(callback));
});
...
Query.prototype.deleteOne = function(filter, options, callback) {
  ...
  if (mquery.canMerge(filter)) {
    ...
    this.error(new objectParameter(filter, 'filter', 'deleteOne'));
  }
...
Query.prototype._deleteOne = wrapThunk(function(callback) {
  ...
  return Query.base.deleteOne.call(this, queryhelpers.handleDeleteWriteOpResult(callback));
});
...
Query.prototype.deleteMany = function(filter, options, callback) {
  ...
  if (mquery.canMerge(filter)) {
    ...
    this.error(new objectParameter(filter, 'filter', 'deleteMany'));
  }
...
Query.prototype._deleteMany = wrapThunk(function(callback) {
  ...
  return Query.base.deleteMany.call(this, queryhelpers.handleDeleteWriteOpResult(callback));
});
...
function completeOne(model, doc, res, options, fields, userProvidedFields, pop, callback) {
  ...
  const casted = queryhelpers.createModel(model, doc, fields, userProvidedFields, options);
  try {
...
function _update(query, op, filter, doc, options, callback) {
  ...
  if (!(filter instanceof Query) &&
    ...
    query.error(new objectParameter(filter, 'filter', op));
  } else {
    query.merge(filter);
  }
...
function _orFailError(err, query) {
  ...
  if (err == null) {
    err = new notFound(query.getQuery(), query.model.modelName);
  }
...
Query.prototype.cast = function(model, obj) {
  ...
  try {
    return cast$1(model.schema, obj, {
...
Query.prototype._applyPaths = function applyPaths() {
  this._fields = this._fields || {};
  queryhelpers.applyPaths(this._fields, this.model.schema);
...
Query.prototype.cursor = function cursor(opts) {
  ...
  try {
    ...
    return (new QueryCursor_1(this, options))._markError(err);
  }

  return new QueryCursor_1(this, options);
};
