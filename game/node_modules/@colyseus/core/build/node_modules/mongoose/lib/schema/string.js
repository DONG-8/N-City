...
var SchemaStringOptions = require('../options/SchemaStringOptions.js');
var string$1 = require('../cast/string.js');
...
SchemaString.prototype.enum = function() {
  ...
  if (utils.isObject(arguments[0])) {
    if (Array.isArray(arguments[0].values)) {
      ...
      errorMessage = index.messages.String.enum;
    }
  } else {
    values = arguments;
    errorMessage = index.messages.String.enum;
...
SchemaString.prototype.minlength = function(value, message) {
  ...
  if (value !== null && value !== undefined) {
    let msg = message || index.messages.String.minlength;
...
SchemaString.prototype.maxlength = function(value, message) {
  ...
  if (value !== null && value !== undefined) {
    let msg = message || index.messages.String.maxlength;
...
SchemaString.prototype.match = function match(regExp, message) {
  ...
  const msg = message || index.messages.String.match;
