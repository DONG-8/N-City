...
var mixed = require('./schema/mixed.js');
var objectExpected = require('./error/objectExpected.js');
var objectParameter = require('./error/objectParameter.js');
var parallelValidate = require('./error/parallelValidate.js');
var schema = require('./schema.js');
var strict = require('./error/strict.js');
var validation = require('./error/validation.js');
var validator = require('./error/validator.js');
var virtualtype = require('./virtualtype.js');
var promiseOrCallback = require('./helpers/promiseOrCallback.js');
var cleanModifiedSubpaths = require('./helpers/document/cleanModifiedSubpaths.js');
var compile = require('./helpers/document/compile.js');
var common = require('./helpers/common.js');
var get = require('./helpers/get.js');
var getEmbeddedDiscriminatorPath = require('./helpers/document/getEmbeddedDiscriminatorPath.js');
var handleSpreadDoc = require('./helpers/document/handleSpreadDoc.js');
var idGetter = require('./plugins/idGetter.js');
var immediate = require('./helpers/immediate.js');
var isDefiningProjection = require('./helpers/projection/isDefiningProjection.js');
var isExclusive = require('./helpers/projection/isExclusive.js');
var util = require('util');
var options = require('./options.js');
var index$1 = require('../../mpath/index.js');
var queryhelpers = require('./queryhelpers.js');
var utils = require('./utils.js');
var isPromise = require('./helpers/isPromise.js');
var symbols = require('./helpers/symbols.js');
var symbols$1 = require('./schema/symbols.js');
var embedded = require('./types/embedded.js');
require('./types/array.js');
require('./types/documentarray.js');
...
var document = _commonjsHelpers.createCommonjsModule(function (module, exports) {
...
const compile$1 = compile['default'].compile;
const defineKey = compile['default'].defineKey;
const flatten = common['default'].flatten;
...
const inspect = util__default['default'].inspect;
...
const documentArrayParent = symbols['default'].documentArrayParent;
const documentIsModified = symbols['default'].documentIsModified;
const documentModifiedPaths = symbols['default'].documentModifiedPaths;
const documentSchemaSymbol = symbols['default'].documentSchemaSymbol;
const getSymbol = symbols['default'].getSymbol;
const populateModelSymbol = symbols['default'].populateModelSymbol;
const scopeSymbol = symbols['default'].scopeSymbol;
const schemaMixedSymbol = symbols$1['default'].schemaMixedSymbol;
let Embedded;
...
Document.prototype.$session = function $session(session) {
  ...
  if (session != null && session.hasEnded) {
    throw new index('Cannot set a document\'s session to a session that has ended. Make sure you haven\'t ' +
...
Document.prototype.$set = function $set(path, val, type, options) {
  ...
  if (pathType === 'nested' && val) {
    ...
    this.invalidate(path, new index.CastError('Object', val, path));
    return this;
  }
  ...
  try {
    ...
    if (e instanceof index.StrictModeError && e.isImmutableError) {
      this.invalidate(path, e);
    } else if (e instanceof index.CastError) {
      this.invalidate(e.path, e);
      if (e.$originalErrorPath) {
        this.invalidate(path,
          new index.CastError(schema.instance, val, path, e.$originalErrorPath));
      }
    } else {
      this.invalidate(path,
        new index.CastError(schema.instance, val, path, e));
    }
    shouldSet = false;
  }
    ...
    if (validationError) {
      for (const key in validationError.errors) {
        ...
        if (!this[documentArrayParent] &&
            validationError.errors[key] instanceof index.CastError) {
...
Document.prototype.validateSync = function(pathsToValidate, options) {
  ...
  if (err) {
    for (const key in err.errors) {
      // Make sure cast errors persist
      if (err.errors[key] instanceof index.CastError) {
...
Document.prototype.$__setSchema = function(schema) {
  ...
  compile$1(schema.tree, this, undefined, schema.options);
