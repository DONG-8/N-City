...
var getSchemaTypes = function getSchemaTypes(schema, doc, path) {
    ...
    while (p--) {
      ...
      if (foundschema.caster) {
        ...
        if (foundschema.schema != null && foundschema.schema.discriminators != null) {
          ...
          const keys = subdoc ? index.get(discriminatorKeyPath, subdoc) || [] : [];
        ...
        if (p !== parts.length && foundschema.schema) {
          ...
          if (parts[p] === '$') {
            ...
            ret = search(
              parts.slice(p + 1),
              schema,
              subdoc ? index.get(trypath, subdoc) : null,
...
module.exports = getSchemaTypes;
//# sourceMappingURL=getSchemaTypes.js.map
