...
var SchemaDateOptions = require('../options/SchemaDateOptions.js');
var schematype = require('../schematype.js');
var date$1 = require('../cast/date.js');
...
SchemaDate.prototype.min = function(value, message) {
  ...
  if (value) {
    let msg = message || index.messages.Date.min;
...
SchemaDate.prototype.max = function(value, message) {
  ...
  if (value) {
    let msg = message || index.messages.Date.max;
    if (typeof msg === 'string') {
