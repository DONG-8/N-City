...
import SchemaArrayOptions_1 from '../options/SchemaArrayOptions.mjs';
import schematype from '../schematype.mjs';
import mixed from './mixed.mjs';
import arrayDepth_1 from '../helpers/arrayDepth.mjs';
...
function SchemaArray(key, cast, options, schemaOptions) {
  // lazy load
  EmbeddedDoc || (EmbeddedDoc = types.Embedded);
...
SchemaArray.prototype.OptionsConstructor = SchemaArrayOptions_1;
...
SchemaArray.prototype._applySetters = function(value, scope, init, priorVal) {
  if (this.casterConstructor.$isMongooseArray &&
    ...
    if (value != null && value.length > 0) {
      const valueDepth = arrayDepth_1(value);
...
SchemaArray.prototype.cast = function(value, doc, init, prev, options) {
  // lazy load
  MongooseArray || (MongooseArray = types.Array);
