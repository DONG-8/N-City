...
var SchemaObjectIdOptions = require('../options/SchemaObjectIdOptions.js');
var schematype = require('../schematype.js');
var objectid$2 = require('../cast/objectid.js');
var objectid$1 = require('../types/objectid.js');
...
ObjectId._checkRequired = v => v instanceof objectid$1;
...
ObjectId.prototype.cast = function(value, doc, init) {
  if (schematype._isRef(this, value, doc, init)) {
    ...
    if (value instanceof objectid$1) {
      return value;
    } else if (value != null && (value.constructor.name || '').toLowerCase() === 'objectid') {
      return new objectid$1(value.toHexString());
    }
