...
const Document = document_provider['default']();
...
if (util__default['default'].inspect.custom) {
  ...
  */
  ...
  EmbeddedDocument.prototype[util__default['default'].inspect.custom] = EmbeddedDocument.prototype.inspect;
}
...
EmbeddedDocument.prototype.invalidate = function(path, err, val) {
  ...
  if (!this[documentArrayParent] || this.__index == null) {
    if (err[validatorErrorSymbol] || err instanceof validation) {
