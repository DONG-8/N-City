...
var mongooseError = require('./mongooseError.js');
...
var parallelSave = require('./parallelSave.js');
var overwriteModel = require('./overwriteModel.js');
var missingSchema = require('./missingSchema.js');
var divergentArray = require('./divergentArray.js');
var strict = require('./strict.js');

var error = _commonjsHelpers.createCommonjsModule(function (module, exports) {
...
mongooseError.messages = messages;
...
mongooseError.DocumentNotFoundError = notFound;
...
mongooseError.ValidationError = validation;
...
mongooseError.ValidatorError = validator;
...
mongooseError.VersionError = version;
...
mongooseError.ParallelSaveError = parallelSave;
...
mongooseError.OverwriteModelError = overwriteModel;
...
mongooseError.MissingSchemaError = missingSchema;
...
mongooseError.DivergentArrayError = divergentArray;
...
mongooseError.StrictModeError = strict;
});
