...
import decimal128$1 from '../types/decimal128.mjs';
import decimal128$2 from '../cast/decimal128.mjs';
...
const castDecimal128 = decimal128$2;
...
Decimal128._defaultCaster = v => {
  if (v != null && !(v instanceof decimal128$1)) {
    throw new Error();
  }
  return v;
};
...
Decimal128._checkRequired = v => v instanceof decimal128$1;
...
export default decimal128;
//# sourceMappingURL=decimal128.mjs.map
