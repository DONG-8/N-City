...
var AggregationCursor = require('./cursor/AggregationCursor.js');
...
var stringifyFunctionOperators = require('./helpers/aggregate/stringifyFunctionOperators.js');
...
function Aggregate(pipeline) {
  ...
  if (arguments.length === 1 && util__default['default'].isArray(pipeline)) {
...
Aggregate.prototype.append = function() {
  const args = (arguments.length === 1 && util__default['default'].isArray(arguments[0]))
    ? arguments[0]
...
Aggregate.prototype.addFields = function(arg) {
  const fields = {};
  if (typeof arg === 'object' && !util__default['default'].isArray(arg)) {
...
Aggregate.prototype.addCursorFlag = util__default['default'].deprecate(function(flag, value) {
  if (!this.options) {
    this.options = {};
  }
