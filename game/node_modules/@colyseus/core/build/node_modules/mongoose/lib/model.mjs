...
import ChangeStream_1 from './cursor/ChangeStream.mjs';
import document from './document.mjs';
import notFound from './error/notFound.mjs';
import divergentArray from './error/divergentArray.mjs';
import require$$0 from 'events';
import buffer from './types/buffer.mjs';
import error from './error/index.mjs';
import overwriteModel from './error/overwriteModel.mjs';
import promise_provider from './promise_provider.mjs';
import query from './query.mjs';
import removeOptions from './options/removeOptions.mjs';
import saveOptions from './options/saveOptions.mjs';
import schema from './schema.mjs';
import serverSelection from './error/serverSelection.mjs';
import validation from './error/validation.mjs';
import version from './error/version.mjs';
import parallelSave from './error/parallelSave.mjs';
import applyQueryMiddleware_1 from './helpers/query/applyQueryMiddleware.mjs';
import applyHooks_1 from './helpers/model/applyHooks.mjs';
import applyMethods from './helpers/model/applyMethods.mjs';
import applyStaticHooks from './helpers/model/applyStaticHooks.mjs';
import applyStatics from './helpers/model/applyStatics.mjs';
import applyWriteConcern from './helpers/schema/applyWriteConcern.mjs';
import assignVals from './helpers/populate/assignVals.mjs';
import castBulkWrite from './helpers/model/castBulkWrite.mjs';
import createPopulateQueryFilter from './helpers/populate/createPopulateQueryFilter.mjs';
import getDefaultBulkwriteResult_1 from './helpers/getDefaultBulkwriteResult.mjs';
import discriminator from './helpers/model/discriminator.mjs';
import each from './helpers/each.mjs';
import get from './helpers/get.mjs';
import getDiscriminatorByValue from './helpers/discriminator/getDiscriminatorByValue.mjs';
import getModelsMapForPopulate from './helpers/populate/getModelsMapForPopulate.mjs';
import immediate from './helpers/immediate.mjs';
import options from './options.mjs';
import isDefaultIdIndex from './helpers/indexes/isDefaultIdIndex.mjs';
import isIndexEqual from './helpers/indexes/isIndexEqual.mjs';
import isPathSelectedInclusive from './helpers/projection/isPathSelectedInclusive.mjs';
import leanPopulateMap from './helpers/populate/leanPopulateMap.mjs';
import modifiedPaths from './helpers/update/modifiedPaths.mjs';
import parallelLimit_1 from './helpers/parallelLimit.mjs';
import removeDeselectedForeignField from './helpers/populate/removeDeselectedForeignField.mjs';
import util from 'util';
import utils from './utils.mjs';
import symbols from './helpers/symbols.mjs';
import queryhelpers from './queryhelpers.mjs';
...
const internalToObjectOptions = options.internalToObjectOptions;
...
const arrayAtomicsSymbol = symbols.arrayAtomicsSymbol;
const modelCollectionSymbol = Symbol('mongoose#Model#collection');
const modelDbSymbol = Symbol('mongoose#Model#db');
const modelSymbol = symbols.modelSymbol;
...
function _checkContext(ctx, fnName) {
  ...
  if (ctx == null || ctx === commonjsGlobal) {
    throw new error('`Model.' + fnName + '()` cannot run without a ' +
...
Model.watch = function(pipeline, options) {
  ...
  return new ChangeStream_1(changeStreamThunk, pipeline, options);
};
...
Model.$__insertMany = function(arr, options, callback) {
  ...
  parallelLimit_1(toExecute, limit, function(error, docs) {
    if (error) {
      callback(error, null);
      return;
    }
...
Model.bulkWrite = function(ops, options, callback) {
  ...
  return this.db.base._promiseOrCallback(callback, cb => {
    ...
    each(validations, (fn, cb) => fn(cb), error => {
      ...
      if (ops.length === 0) {
        return cb(null, getDefaultBulkwriteResult_1());
      }
...
Model.geoSearch = function(conditions, options, callback) {
  ...
  return this.db.base._promiseOrCallback(callback, cb => {
    ...
    if (conditions === undefined || !utils.isObject(conditions)) {
      error$1 = new error('Must pass conditions to geoSearch');
    } else if (!options.near) {
      error$1 = new error('Must specify the near option in geoSearch');
    } else if (!Array.isArray(options.near)) {
      error$1 = new error('near option must be an array [x, y]');
    }
...
Model.compile = function compile(name, schema, collectionName, connection, base) {
  ...
  applyQueryMiddleware_1(model.Query, model);
