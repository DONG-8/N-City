...
class CoreMongooseArray extends Array {
  ...
  addToSet() {
    ...
    const added = [];
    let type = '';
    if (values[0] instanceof embedded) {
      type = 'doc';
...
var core_array = CoreMongooseArray;

export default core_array;
//# sourceMappingURL=core_array.mjs.map
