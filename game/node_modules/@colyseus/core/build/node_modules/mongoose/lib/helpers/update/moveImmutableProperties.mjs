...
var moveImmutableProperties = function moveImmutableProperties(schema, update, ctx) {
  if (update == null) {
    return;
  }
...
export default moveImmutableProperties;
//# sourceMappingURL=moveImmutableProperties.mjs.map
