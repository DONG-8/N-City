...
import SkipPopulateValue from './SkipPopulateValue.mjs';
import get from '../get.mjs';
import getDiscriminatorByValue from '../discriminator/getDiscriminatorByValue.mjs';
import isPathExcluded from '../projection/isPathExcluded.mjs';
import getSchemaTypes from './getSchemaTypes.mjs';
import getVirtual_1 from './getVirtual.mjs';
import lookupLocalFields from './lookupLocalFields.mjs';
import mpath from '../../../../mpath/index.mjs';
import normalizeRefPath from './normalizeRefPath.mjs';
...
var getModelsMapForPopulate = function getModelsMapForPopulate(model, docs, options) {
  ...
  for (i = 0; i < len; i++) {
    ...
    const _virtualRes = getVirtual_1(model.schema, options.path);
  ...
  function _getModelNames(doc, schema) {
    ...
    if (modelNameFromQuery) {
      ...
      const _virtualRes = getVirtual_1(modelForCurrentDoc.schema, options.path);
      const virtual = _virtualRes == null ? null : _virtualRes.virtual;
...
export default getModelsMapForPopulate;
//# sourceMappingURL=getModelsMapForPopulate.mjs.map
