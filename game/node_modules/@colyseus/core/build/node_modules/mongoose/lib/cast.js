...
var text = require('./schema/operators/text.js');
var get = require('./helpers/get.js');
var getSchemaDiscriminatorByValue = require('./helpers/discriminator/getSchemaDiscriminatorByValue.js');
 ...
 * @api private
 */
var cast = function cast(schema, obj, options, context) {
  if (Array.isArray(obj)) {
    throw new Error('Query filter must be an object, got an array ', util__default['default'].inspect(obj));
  }
    ...
    if (path === '$or' || path === '$nor' || path === '$and') {
      ...
      if (!schematype) {
        ...
        if (isObject(val)) {
          ...
          if (geo) {
            const numbertype = new index.Number('__QueryCasting__');
            let value = val[geo];
