...
var index$2 = require('../../kareem/index.js');
...
var VirtualOptions = require('./options/VirtualOptions.js');
var virtualtype = require('./virtualtype.js');
var addAutoId = require('./helpers/schema/addAutoId.js');
var symbols = require('./helpers/symbols.js');
var get = require('./helpers/get.js');
var getIndexes = require('./helpers/schema/getIndexes.js');
var merge = require('./helpers/schema/merge.js');
var index = require('../../mpath/index.js');
var driver = require('./driver.js');
var setupTimestamps = require('./helpers/timestamps/setupTimestamps.js');
var util = require('util');
var utils = require('./utils.js');
var validateRef = require('./helpers/populate/validateRef.js');
var applyQueryMiddleware = require('./helpers/query/applyQueryMiddleware.js');
var applyHooks = require('./helpers/model/applyHooks.js');
var index$1 = require('./schema/index.js');
...
var schema = _commonjsHelpers.createCommonjsModule(function (module, exports) {
...
const arrayParentSymbol = symbols['default'].arrayParentSymbol;




const readPref = driver['default'].get().ReadPreference;
...
const queryHooks = applyQueryMiddleware.
  middlewareFunctions;
const documentHooks = applyHooks.middlewareFunctions;
...
const setSafe = util__default['default'].deprecate(function setSafe(options, value) {
...
Schema.prototype.virtual = function(name, options) {
  ...
  if (utils.hasUserDefinedProperty(options, ['ref', 'refPath'])) {
    ...
    this.pre('init', function(obj) {
      if (index.has(name, obj)) {
        const _v = index.get(name, obj);
...
Schema.Types = MongooseTypes = index$1;
