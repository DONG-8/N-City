...
import SchemaDocumentArrayOptions_1 from '../options/SchemaDocumentArrayOptions.mjs';
...
import handleIdOption from '../helpers/schema/handleIdOption.mjs';
import util from 'util';
import utils from '../utils.mjs';
import getConstructor from '../helpers/discriminator/getConstructor.mjs';
import symbols from '../helpers/symbols.mjs';
import embedded from '../types/embedded.mjs';
import documentarray$1 from '../types/documentarray.mjs';
...
const arrayPathSymbol = symbols.arrayPathSymbol;
...
function DocumentArrayPath(key, schema, options, schemaOptions) {
  ...
  array.call(this, key, EmbeddedDocument, options);
 ...
 */
DocumentArrayPath.prototype = Object.create(array.prototype);
DocumentArrayPath.prototype.constructor = DocumentArrayPath;
DocumentArrayPath.prototype.OptionsConstructor = SchemaDocumentArrayOptions_1;
...
function _createConstructor(schema, options, baseClass) {
  Subdocument || (Subdocument = embedded);
...
DocumentArrayPath.prototype.doValidate = function(array, fn, scope, options) {
  // lazy load
  MongooseDocumentArray || (MongooseDocumentArray = documentarray$1);
...
DocumentArrayPath.prototype.cast = function(value, doc, init, prev, options) {
  ...
  if (!Array.isArray(value)) {
    if (!init && !DocumentArrayPath.options.castNonArrays) {
      throw new cast('DocumentArray', util.inspect(value), this.path, null, this);
    }
      ...
      if (init) {
        ...
        if (prev && subdoc && utils.deepEqual(subdoc.toObject(_opts), value[i])) {
          ...
          try {
            ...
            throw new cast('embedded', valueInErrorMessage,
...
var documentarray = DocumentArrayPath;

export default documentarray;
//# sourceMappingURL=documentarray.mjs.map
