...
import checkEmbeddedDiscriminatorKeyProjection from './helpers/discriminator/checkEmbeddedDiscriminatorKeyProjection.mjs';
...
exports.createModel = function createModel(model, doc, fields, userProvidedFields, options) {
  ...
  if (key && value && model.discriminators) {
    ...
    if (discriminator) {
      const _fields = clone_1(userProvidedFields);
