import buffer$1 from '../types/buffer.mjs';
import SchemaBufferOptions_1 from '../options/SchemaBufferOptions.mjs';
...
SchemaBuffer.prototype.OptionsConstructor = SchemaBufferOptions_1;
...
SchemaBuffer.prototype.cast = function(value, doc, init) {
  ...
  if (schematype._isRef(this, value, doc, init)) {
    ...
    if (Buffer.isBuffer(value)) {
      if (!value || !value.isMongooseBuffer) {
        value = new buffer$1(value, [this.path, doc]);
    ...
    if (value instanceof Binary) {
      ret = new buffer$1(value.value(true), [this.path, doc]);
  ...
  if (
    ...
    ret = new buffer$1(value, [this.path, doc]);
    if (this.options.subtype != null) {
