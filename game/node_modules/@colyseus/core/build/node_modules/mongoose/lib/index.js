...
var index = require('./drivers/node-mongodb-native/index.js');
var document = require('./document.js');
var require$$0 = require('events');
var schema = require('./schema.js');
var schematype = require('./schematype.js');
var index$2 = require('./schema/index.js');
var virtualtype = require('./virtualtype.js');
var connectionstate = require('./connectionstate.js');
var validoptions = require('./validoptions.js');
var index$1 = require('./types/index.js');
var query = require('./query.js');
var model = require('./model.js');
var applyPlugins = require('./helpers/schema/applyPlugins.js');
var get = require('./helpers/get.js');
var promiseOrCallback = require('./helpers/promiseOrCallback.js');
var index$5 = require('../../mongoose-legacy-pluralize/index.js');
var utils = require('./utils.js');
var _package = require('../package.json.js');
var cast$1 = require('./cast.js');
var removeSubdocs = require('./plugins/removeSubdocs.js');
var saveSubdocs = require('./plugins/saveSubdocs.js');
var trackTransaction = require('./plugins/trackTransaction.js');
var validateBeforeSave = require('./plugins/validateBeforeSave.js');
var aggregate = require('./aggregate.js');
var promise_provider = require('./promise_provider.js');
var sharding = require('./plugins/sharding.js');
require('./helpers/printJestWarning.js');
var document_provider = require('./document_provider.js');
var index$3 = require('./error/index.js');
var cast = require('./error/cast.js');
var SchemaTypeOptions = require('./options/SchemaTypeOptions.js');
var index$4 = require('../../mongodb/index.js');
...
if (_commonjsHelpers.commonjsGlobal.MONGOOSE_DRIVER_PATH) {
  const deprecationWarning = 'The `MONGOOSE_DRIVER_PATH` global property is ' +
    'deprecated. Use `mongoose.driver.set()` instead.';
  const setDriver = util__default['default'].deprecate(function() {
    driver['default'].set(_commonjsHelpers.commonjsRequire(_commonjsHelpers.commonjsGlobal.MONGOOSE_DRIVER_PATH));
  }, deprecationWarning);
  setDriver();
} else {
  driver['default'].set(index['default']);
}
...
function Mongoose(options) {
  ...
  Object.defineProperty(this, 'plugins', {
    ...
    value: [
      ...
      [sharding['default'], { deduplicate: true }],
...
Mongoose.prototype.driver = driver['default'];
...
const Connection = driver['default'].get().getConnection();

/*!
 * Collection
 */

const Collection = driver['default'].get().Collection;
...
Mongoose.prototype.version = _package['default'].version;
...
Mongoose.prototype.Types = index$1;
...
Mongoose.prototype.DocumentProvider = document_provider['default'];
...
Mongoose.prototype.ObjectId = index$2.ObjectId;
...
Mongoose.prototype.Decimal128 = index$2.Decimal128;
...
Mongoose.prototype.Mixed = index$2.Mixed;
...
Mongoose.prototype.Date = index$2.Date;
...
Mongoose.prototype.Number = index$2.Number;
...
Mongoose.prototype.Error = index$3;
...
Mongoose.prototype.SchemaTypeOptions = SchemaTypeOptions;
...
Mongoose.prototype.mongo = index$4;
