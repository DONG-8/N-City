...
var exists = require('./schema/operators/exists.js');
var type = require('./schema/operators/type.js');
var get = require('./helpers/get.js');
var handleImmutable = require('./helpers/schematype/handleImmutable.js');
...
var schematype = _commonjsHelpers.createCommonjsModule(function (module, exports) {
...
const schemaTypeSymbol = symbols['default'].schemaTypeSymbol;


const validatorErrorSymbol = symbols['default'].validatorErrorSymbol;
const documentIsModified = symbols['default'].documentIsModified;

const populateModelSymbol = symbols['default'].populateModelSymbol;

const CastError = index.CastError;
const ValidatorError = index.ValidatorError;
...
SchemaType.prototype.default = function(val) {
  if (arguments.length === 1) {
    ...
    if (val != null && val.instanceOfSchema) {
      throw new index('Cannot set default value of path `' + this.path +
...
SchemaType.prototype.validate = function(obj, message, type) {
  if (typeof obj === 'function' || obj && utils.getFunctionName(obj.constructor) === 'RegExp') {
    ...
    if (typeof message === 'function') {
      ...
      if (message == null) {
        message = index.messages.general.default;
      }
      if (!type) {
        type = 'user defined';
      }
...
const handleIsAsync = util__default['default'].deprecate(function handleIsAsync() {},
...
SchemaType.prototype.required = function(required, message) {
  ...
  const msg = message || index.messages.general.required;
