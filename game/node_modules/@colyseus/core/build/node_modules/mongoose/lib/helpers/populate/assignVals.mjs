...
import assignRawDocsToIdStructure_1 from './assignRawDocsToIdStructure.mjs';
import get from '../get.mjs';
import getVirtual_1 from './getVirtual.mjs';
import leanPopulateMap from './leanPopulateMap.mjs';
import lookupLocalFields from './lookupLocalFields.mjs';
import mpath from '../../../../mpath/index.mjs';
import utils from '../../utils.mjs';
import require$$0 from '../../../../../_virtual/index21.js_commonjs-proxy';

const sift = require$$0.default;
...
var assignVals = function assignVals(o) {
  ...
  assignRawDocsToIdStructure_1(o.rawIds, o.rawDocs, o.rawOrder, populateOptions);
  ...
  for (i = 0; i < docs.length; ++i) {
    ...
    if (existingVal == null && !getVirtual_1(o.originalModel.schema, _path)) {
      continue;
    }
...
export default assignVals;
//# sourceMappingURL=assignVals.mjs.map
