...
import VirtualOptions_1 from './options/VirtualOptions.mjs';
import virtualtype from './virtualtype.mjs';
import addAutoId from './helpers/schema/addAutoId.mjs';
import symbols from './helpers/symbols.mjs';
import get from './helpers/get.mjs';
import getIndexes from './helpers/schema/getIndexes.mjs';
import merge from './helpers/schema/merge.mjs';
import mpath from '../../mpath/index.mjs';
import driver_1 from './driver.mjs';
import setupTimestamps from './helpers/timestamps/setupTimestamps.mjs';
import util from 'util';
import utils from './utils.mjs';
import validateRef_1 from './helpers/populate/validateRef.mjs';
...
const arrayParentSymbol = symbols.arrayParentSymbol;




const readPref = driver_1.get().ReadPreference;
...
const queryHooks = applyQueryMiddleware_1.
  middlewareFunctions;
const documentHooks = applyHooks_1.middlewareFunctions;
...
Schema.prototype.add = function add(obj, prefix) {
  ...
  for (const key of keys) {
    ...
    if (!(utils.isPOJO(obj[key]) || obj[key] instanceof SchemaTypeOptions_1)) {
...
Schema.prototype.interpretAsType = function(path, obj, options) {
  ...
  if (!utils.isPOJO(obj) && !(obj instanceof SchemaTypeOptions_1)) {
...
Schema.prototype.virtual = function(name, options) {
  ...
  options = new VirtualOptions_1(options);
...
Schema.Types = MongooseTypes = schema$1;
