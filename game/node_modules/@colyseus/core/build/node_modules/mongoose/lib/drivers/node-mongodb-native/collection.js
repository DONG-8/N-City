...
var collection$1 = require('../../collection.js');
var mongooseError = require('../../error/mongooseError.js');
var index = require('../../../../mongodb/index.js');
...
NativeCollection.prototype.__proto__ = collection$1.prototype;
...
NativeCollection.prototype.onOpen = function() {
  ...
  if (_this.opts.autoCreate === false) {
    ...
    collection$1.prototype.onOpen.call(_this);
    return _this.collection;
  }
...
NativeCollection.prototype.onClose = function(force) {
  collection$1.prototype.onClose.call(this, force);
};
  ...
  NativeCollection.prototype[i] = function() {
    ...
    if (debug) {
      if (typeof debug === 'function') {
        debug.apply(_this,
          [_this.name, i].concat(index$1(args, 0, args.length - 1)));
      } else if (debug instanceof Stream__default['default'].Writable) {
...
function inspectable(representation) {
  ...
  if (util__default['default'].inspect.custom) {
    ret[util__default['default'].inspect.custom] = ret.inspect;
  }
  return ret;
}
function map(o) {
...
function format(obj, sub, color, shell) {
  ...
  const clone$1 = clone;
  let x = clone$1(obj, { transform: false });
