...
import SchemaStringOptions_1 from '../options/SchemaStringOptions.mjs';
import string$1 from '../cast/string.mjs';
...
SchemaString.prototype.minlength = function(value, message) {
  ...
  if (value !== null && value !== undefined) {
    let msg = message || error.messages.String.minlength;
...
SchemaString.prototype.maxlength = function(value, message) {
  ...
  if (value !== null && value !== undefined) {
    let msg = message || error.messages.String.maxlength;
...
SchemaString.prototype.match = function match(regExp, message) {
  ...
  const msg = message || error.messages.String.match;
