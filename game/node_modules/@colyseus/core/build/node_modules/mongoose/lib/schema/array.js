...
var type = require('./operators/type.js');
var mongooseError = require('../error/mongooseError.js');
var SchemaArrayOptions = require('../options/SchemaArrayOptions.js');
var schematype = require('../schematype.js');
var mixed = require('./mixed.js');
var arrayDepth = require('../helpers/arrayDepth.js');
var cast$1 = require('../cast.js');
var get = require('../helpers/get.js');
var isOperator = require('../helpers/query/isOperator.js');
...
function SchemaArray(key, cast, options, schemaOptions) {
  // lazy load
  EmbeddedDoc || (EmbeddedDoc = index.Embedded);
...
SchemaArray.prototype.cast = function(value, doc, init, prev, options) {
  // lazy load
  MongooseArray || (MongooseArray = index.Array);
  ...
  if (Array.isArray(value)) {
    ...
    if (caster && this.casterConstructor !== mixed) {
      try {
        ...
        // rethrow
        throw new CastError('[' + e.kind + ']', util__default['default'].inspect(value), this.path + '.' + i, e, this);
      }
    }
  ...
  throw new CastError('Array', util__default['default'].inspect(value), this.path, null, this);
};
...
handle.$geoIntersects = geospatial['default'].cast$geoIntersects;
...
handle.$near =
handle.$nearSphere = geospatial['default'].cast$near;

handle.$within =
handle.$geoWithin = geospatial['default'].cast$within;
