...
var SchemaDocumentArrayOptions = require('../options/SchemaDocumentArrayOptions.js');
...
var documentarray$1 = require('../types/documentarray.js');
...
const arrayPathSymbol = symbols['default'].arrayPathSymbol;
...
DocumentArrayPath.prototype.cast = function(value, doc, init, prev, options) {
  ...
  if (!Array.isArray(value)) {
    if (!init && !DocumentArrayPath.options.castNonArrays) {
      throw new cast('DocumentArray', util__default['default'].inspect(value), this.path, null, this);
    }
      ...
      if (init) {
        ...
        if (prev && subdoc && utils.deepEqual(subdoc.toObject(_opts), value[i])) {
          ...
          try {
            ...
            const valueInErrorMessage = util__default['default'].inspect(value[i]);
...
//# sourceMappingURL=documentarray.js.map
