import AggregationCursor_1 from './cursor/AggregationCursor.mjs';
...
import stringifyFunctionOperators from './helpers/aggregate/stringifyFunctionOperators.mjs';
...
Aggregate.prototype.exec = function(callback) {
  ...
  if (this.options && this.options.cursor) {
    return new AggregationCursor_1(this);
  }
