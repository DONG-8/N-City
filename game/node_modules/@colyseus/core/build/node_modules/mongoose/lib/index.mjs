import { createCommonjsModule, commonjsGlobal, commonjsRequire } from '../../../_virtual/_commonjsHelpers.js';
import util from 'util';
import driver_1 from './driver.mjs';
import nodeMongodbNative from './drivers/node-mongodb-native/index.mjs';
import document from './document.mjs';
import require$$0 from 'events';
import schema from './schema.mjs';
import schematype from './schematype.mjs';
import schema$1 from './schema/index.mjs';
import virtualtype from './virtualtype.mjs';
import connectionstate from './connectionstate.mjs';
import validoptions from './validoptions.mjs';
import types from './types/index.mjs';
import query from './query.mjs';
import model from './model.mjs';
import applyPlugins from './helpers/schema/applyPlugins.mjs';
import get from './helpers/get.mjs';
import promiseOrCallback from './helpers/promiseOrCallback.mjs';
import mongooseLegacyPluralize from '../../mongoose-legacy-pluralize/index.mjs';
import utils from './utils.mjs';
import pkg from '../package.mjs';
import cast$1 from './cast.mjs';
import removeSubdocs from './plugins/removeSubdocs.mjs';
import saveSubdocs from './plugins/saveSubdocs.mjs';
import trackTransaction from './plugins/trackTransaction.mjs';
import validateBeforeSave from './plugins/validateBeforeSave.mjs';
import aggregate from './aggregate.mjs';
import promise_provider from './promise_provider.mjs';
import sharding from './plugins/sharding.mjs';
import './helpers/printJestWarning.mjs';
import document_provider from './document_provider.mjs';
import error from './error/index.mjs';
import cast from './error/cast.mjs';
import SchemaTypeOptions_1 from './options/SchemaTypeOptions.mjs';
...
if (commonjsGlobal.MONGOOSE_DRIVER_PATH) {
  const deprecationWarning = 'The `MONGOOSE_DRIVER_PATH` global property is ' +
    'deprecated. Use `mongoose.driver.set()` instead.';
  const setDriver = util.deprecate(function() {
    driver_1.set(commonjsRequire(commonjsGlobal.MONGOOSE_DRIVER_PATH));
  }, deprecationWarning);
  setDriver();
} else {
  driver_1.set(nodeMongodbNative);
}
...
function Mongoose(options) {
  ...
  if (this.options.pluralization) {
    this._pluralize = mongooseLegacyPluralize;
  }
 ...
 * @api public
 */
Mongoose.prototype.STATES = connectionstate;
...
Mongoose.prototype.driver = driver_1;
...
Mongoose.prototype.set = function(key, value) {
  ...
  if (validoptions.indexOf(key) === -1) throw new Error(`\`${key}\` is an invalid option.`);
...
Mongoose.prototype.model = function(name, schema$1, collection, skipInit) {
  const _mongoose = this instanceof Mongoose ? this : mongoose;
  ...
  if (typeof name === 'function') {
    model$1 = name;
    name = model$1.name;
    if (!(model$1.prototype instanceof model)) {
  ...
  if (utils.isObject(schema$1) && !(schema$1 instanceof schema)) {
    schema$1 = new schema(schema$1);
  }
  if (schema$1 && !(schema$1 instanceof schema)) {
  ...
  if (!_mongoose.modelSchemas[name]) {
    if (schema$1) {
      ...
      _mongoose.modelSchemas[name] = schema$1;
    } else {
      throw new mongoose.Error.MissingSchemaError(name);
    }
  }

  const originalSchema = schema$1;
  if (schema$1) {
    if (_mongoose.get('cloneSchemas')) {
      schema$1 = schema$1.clone();
    }
    _mongoose._applyPlugins(schema$1);
  }
  ...
  if (_mongoose.models[name] && options.cache !== false && overwriteModels !== true) {
    ...
    if (collection && collection !== _mongoose.models[name].collection.name) {
      ...
      model$1 = _mongoose.models[name];
      schema$1 = model$1.prototype.schema;
      sub = model$1.__subclass(_mongoose.connection, schema$1, collection);
  ...
  if (!schema$1) {
    schema$1 = this.modelSchemas[name];
    if (!schema$1) {
      throw new mongoose.Error.MissingSchemaError(name);
    }
  }
  ...
  if (!('pluralization' in schema$1.options)) {
    schema$1.options.pluralization = _mongoose.options.pluralization;
  }

  if (!collection) {
    collection = schema$1.get('collection') ||
      utils.toCollectionName(name, _mongoose.pluralize());
  }

  const connection = options.connection || _mongoose.connection;
  model$1 = _mongoose.Model.compile(model$1 || name, schema$1, collection, connection, _mongoose);

  if (!skipInit) {
    // Errors handled internally, so safe to ignore error
    model$1.init(function $modelInitNoop() {});
  }

  connection.emit('model', model$1);

  if (options.cache === false) {
    return model$1;
  }

  _mongoose.models[name] = model$1;
  return _mongoose.models[name];
};
...
const Connection = driver_1.get().getConnection();

/*!
 * Collection
 */

const Collection = driver_1.get().Collection;
...
Object.defineProperty(Mongoose.prototype, 'Promise', {
  get: function() {
    return promise_provider.get();
  },
  set: function(lib) {
    promise_provider.set(lib);
  }
});
...
Mongoose.prototype.PromiseProvider = promise_provider;
...
Mongoose.prototype.DocumentProvider = document_provider;
...
Mongoose.prototype.ObjectId = schema$1.ObjectId;
...
Mongoose.prototype.Decimal128 = schema$1.Decimal128;
...
Mongoose.prototype.Mixed = schema$1.Mixed;
...
Mongoose.prototype.Date = schema$1.Date;
...
Mongoose.prototype.Number = schema$1.Number;
...
Mongoose.prototype.Error = error;
...
Mongoose.prototype.CastError = cast;
...
Mongoose.prototype.SchemaTypeOptions = SchemaTypeOptions_1;
...
Mongoose.prototype.mongo = mongodb;
...
Mongoose.prototype.mquery = mquery;
