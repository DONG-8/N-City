...
var getIndexes = function getIndexes(schema) {
  let indexes = [];
  ...
  function collectIndexes(schema, prefix, baseSchema) {
    ...
    for (const key of keys) {
      ...
      if (index !== false && index !== null && index !== undefined) {
        const field = {};
        const isObject$1 = isObject(index);
        const options = isObject$1 ? index : {};
        const type = typeof index === 'string' ? index :
          isObject$1 ? index.type :
            false;
...
//# sourceMappingURL=getIndexes.mjs.map
