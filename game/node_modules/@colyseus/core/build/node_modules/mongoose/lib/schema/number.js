...
var SchemaNumberOptions = require('../options/SchemaNumberOptions.js');
var schematype = require('../schematype.js');
var number$1 = require('../cast/number.js');
var bitwise = require('./operators/bitwise.js');
...
SchemaNumber.prototype.min = function(value, message) {
  ...
  if (value !== null && value !== undefined) {
    let msg = message || index.messages.Number.min;
...
SchemaNumber.prototype.max = function(value, message) {
  ...
  if (value !== null && value !== undefined) {
    let msg = message || index.messages.Number.max;
...
SchemaNumber.prototype.enum = function(values, message) {
  ...
  if (!Array.isArray(values)) {
    ...
    message = index.messages.Number.enum;
  }

  message = message == null ? index.messages.Number.enum : message;
