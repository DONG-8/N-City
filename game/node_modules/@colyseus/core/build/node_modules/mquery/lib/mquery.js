...
var index$1 = require('./collection/index.js');
var collection = require('./collection/collection.js');
var bluebird = require('../../bluebird/js/release/bluebird.js');
...
var mquery = _commonjsHelpers.createCommonjsModule(function (module, exports) {
...
var debug = debug__default['default']('mquery');
...
Query.prototype.near = function near() {
  ...
  if (Array.isArray(val.center)) {
    ...
    if (val.center.type != 'Point' || !Array.isArray(val.center.coordinates)) {
      throw new Error(util__default['default'].format('Invalid GeoJSON specified for %s', type));
    }
...
Query.prototype._findAndModify = function(type, callback) {
  assert__default['default'].equal('function', typeof callback);
...
Query.prototype.exec = function exec(op, callback) {
  ...
  assert__default['default'].ok(this.op, 'Missing query type: (find, update, etc)');
...
Query.utils = utils;
Query.env = env;
Query.Collection = index$1;
Query.BaseCollection = collection;
Query.Promise = bluebird;
