...
import collection$1 from './collection/collection.mjs';
import bluebird_1 from '../../bluebird/js/release/bluebird.mjs';

var mquery = createCommonjsModule(function (module, exports) {
...
Query.prototype.find = function(criteria, callback) {
  ...
  debug$1('find', this._collection.collectionName, conds, options);
...
Query.prototype.cursor = function cursor(criteria) {
  ...
  debug$1('findCursor', this._collection.collectionName, conds, options);
...
Query.prototype.findOne = function(criteria, callback) {
  ...
  debug$1('findOne', this._collection.collectionName, conds, options);
...
Query.prototype.count = function(criteria, callback) {
  ...
  debug$1('count', this._collection.collectionName, conds, options);
...
Query.prototype.distinct = function(criteria, field, callback) {
  ...
  debug$1('distinct', this._collection.collectionName, conds, options);
...
function _update(query, op, criteria, doc, options, force, callback) {
  ...
  debug$1('update', query._collection.collectionName, criteria, doc, options);
...
Query.prototype.remove = function(criteria, callback) {
  ...
  debug$1('remove', this._collection.collectionName, conds, options);
...
Query.prototype.deleteOne = function(criteria, callback) {
  ...
  debug$1('deleteOne', this._collection.collectionName, conds, options);
...
Query.prototype._findAndModify = function(type, callback) {
  ...
  debug$1('findAndModify', this._collection.collectionName, conds, doc, options);
...
Query.prototype.stream = function(streamOptions) {
  ...
  debug$1('stream', this._collection.collectionName, conds, options, streamOptions);
...
Query.BaseCollection = collection$1;
Query.Promise = bluebird_1;
...
//# sourceMappingURL=mquery.mjs.map
