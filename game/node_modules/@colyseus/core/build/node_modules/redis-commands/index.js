...
var commands = require('./commands.json.js');

var redisCommands = _commonjsHelpers.createCommonjsModule(function (module, exports) {
 ...
 * @public
 */
exports.list = Object.keys(commands['default']);

var flags = {};
exports.list.forEach(function (commandName) {
  flags[commandName] = commands['default'][commandName].flags.reduce(function (flags, flag) {
    flags[flag] = true;
    return flags
  }, {});
});
...
exports.exists = function (commandName) {
  return Boolean(commands['default'][commandName])
};
...
exports.getKeyIndexes = function (commandName, args, options) {
  var command = commands['default'][commandName];
  if (!command) {
    throw new Error('Unknown command ' + commandName)
  }
