...
import shared$1 from './wireprotocol/shared.mjs';

const retrieveBSON = utils$1.retrieveBSON;

const BSON = retrieveBSON();
const Binary = BSON.Binary;
const uuidV4 = utils$2.uuidV4;
const MongoError = error.MongoError;
const isRetryableError = error.isRetryableError;
...
const isPromiseLike = utils$2.isPromiseLike;

const maybePromise = utils.maybePromise;
...
const maxWireVersion = utils$2.maxWireVersion;
const now = utils.now;
 ...
 * @hideconstructor
 */
class ClientSession extends require$$0 {
  /**
