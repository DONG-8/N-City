...
var Emitter = require$$0__default['default'].EventEmitter;


var shallowClone = utils.shallowClone;
var toError = utils.toError;

var executeLegacyOperation = utils.executeLegacyOperation;
...
util__default['default'].inherits(GridFSBucket, Emitter);
