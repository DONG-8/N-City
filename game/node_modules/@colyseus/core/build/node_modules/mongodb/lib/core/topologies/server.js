...
var pool = require('../connection/pool.js');
var error = require('../error.js');
var index = require('../wireprotocol/index.js');
...
var inherits = util__default['default'].inherits,
  f = util__default['default'].format,
  EventEmitter = require$$0__default['default'].EventEmitter,
  debugOptions = utils.debugOptions,
  retrieveBSON = utils.retrieveBSON,
  MongoError = error.MongoError,
  MongoNetworkError = error.MongoNetworkError,
  CoreCursor = cursor.CoreCursor,
  createCompressionInfo = shared.createCompressionInfo,
  resolveClusterTime = shared.resolveClusterTime,
  SessionMixins = shared.SessionMixins,
  relayEvents = utils$1.relayEvents;

const collationNotSupported = utils$1.collationNotSupported;
const makeClientMetadata = utils$1.makeClientMetadata;
...
Server.prototype.command = function(ns, cmd, options, callback) {
  ...
  index.command(self, ns, cmd, options, callback);
};
...
Server.prototype.query = function(ns, cmd, cursorState, options, callback) {
  index.query(this, ns, cmd, cursorState, options, callback);
};
...
Server.prototype.getMore = function(ns, cursorState, batchSize, options, callback) {
  index.getMore(this, ns, cursorState, batchSize, options, callback);
};
...
Server.prototype.killCursors = function(ns, cursorState, callback) {
  index.killCursors(this, ns, cursorState, callback);
};
...
Server.prototype.insert = function(ns, ops, options, callback) {
  ...
  // Execute write
  return index.insert(self, ns, ops, options, callback);
};
...
Server.prototype.update = function(ns, ops, options, callback) {
  ...
  ops = Array.isArray(ops) ? ops : [ops];
  // Execute write
  return index.update(self, ns, ops, options, callback);
};
...
Server.prototype.remove = function(ns, ops, options, callback) {
  ...
  ops = Array.isArray(ops) ? ops : [ops];
  // Execute write
  return index.remove(self, ns, ops, options, callback);
};
