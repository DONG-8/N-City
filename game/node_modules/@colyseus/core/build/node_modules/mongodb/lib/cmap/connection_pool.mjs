...
import logger from '../core/connection/logger.mjs';
import utils from '../utils.mjs';
import error from '../core/error.mjs';
import connection from './connection.mjs';
import utils$1 from '../core/utils.mjs';
import connect_1 from '../core/connection/connect.mjs';
import errors from './errors.mjs';
import events from './events.mjs';

const EventEmitter = require$$0.EventEmitter;

const makeCounter = utils.makeCounter;
...
function createConnection(pool, callback) {
  ...
  pool[kPermits]--;
  connect_1(connectOptions, pool[kCancellationToken], (err, connection) => {
    if (err) {
      pool[kPermits]++;
...
//# sourceMappingURL=connection_pool.mjs.map
