...
var download = GridFSBucketReadStream;
...
function GridFSBucketReadStream(chunks, files, readPreference, filter, options) {
  ...
  Stream__default['default'].Readable.call(this);
}

util__default['default'].inherits(GridFSBucketReadStream, Stream__default['default'].Readable);
