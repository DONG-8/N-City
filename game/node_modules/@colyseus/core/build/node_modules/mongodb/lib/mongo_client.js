...
var read_preference = require('./core/topologies/read_preference.js');
var native_topology = require('./topologies/native_topology.js');
var connect$1 = require('./operations/connect.js');
require('./encrypter.js');
...
const connect = connect$1.connect;
const validOptions = connect$1.validOptions;
...
function MongoClient(url, options) {
  ...
  if (options && options.autoEncryption)  // Does CSFLE lib check
