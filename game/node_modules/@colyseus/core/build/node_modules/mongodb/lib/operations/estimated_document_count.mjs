...
class EstimatedDocumentCountOperation extends command_v2 {
...
var estimated_document_count = EstimatedDocumentCountOperation;

export default estimated_document_count;
