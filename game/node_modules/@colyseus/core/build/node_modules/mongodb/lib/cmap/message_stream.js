...
var compression = require('../core/wireprotocol/compression.js');
var commands = require('../core/connection/commands.js');
var msg = require('../core/connection/msg.js');
var shared = require('../core/wireprotocol/shared.js');
...
const OP_COMPRESSED = shared.opcodes.OP_COMPRESSED;
const OP_MSG = shared.opcodes.OP_MSG;
...
var message_stream = MessageStream;

module.exports = message_stream;
