import server_description from '../core/sdam/server_description.mjs';

const parseServerType = server_description.parseServerType;
...
export default stream_description;
