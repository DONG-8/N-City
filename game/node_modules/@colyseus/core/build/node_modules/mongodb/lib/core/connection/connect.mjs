...
import auth_provider from '../auth/auth_provider.mjs';
import constants from '../wireprotocol/constants.mjs';
...
const defaultAuthProviders = defaultAuthProviders_1.defaultAuthProviders;
