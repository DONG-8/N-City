...
var db_ops = require('./operations/db_ops.js');
var aggregate = require('./operations/aggregate.js');
var add_user = require('./operations/add_user.js');
var collections = require('./operations/collections.js');
var command = require('./operations/command.js');
var run_command = require('./operations/run_command.js');
var create_collection = require('./operations/create_collection.js');
var create_indexes = require('./operations/create_indexes.js');
var drop = require('./operations/drop.js');
var execute_db_admin_command = require('./operations/execute_db_admin_command.js');
var index_information = require('./operations/index_information.js');
var list_collections = require('./operations/list_collections.js');
var profiling_level = require('./operations/profiling_level.js');
var remove_user = require('./operations/remove_user.js');
var rename = require('./operations/rename.js');
var set_profiling_level = require('./operations/set_profiling_level.js');
...
const getSingleProperty = utils.getSingleProperty;

const handleCallback = utils.handleCallback;
const filterOptions = utils.filterOptions;
const toError = utils.toError;
const ReadPreference = index.ReadPreference;
const MongoError = index.MongoError;
const ObjectID = index.ObjectID;
const Logger = index.Logger;

const conditionallyMergeWriteConcern = utils.conditionallyMergeWriteConcern;
...
// Operations
const createListener = db_ops.createListener;
...
Db.prototype.collection = function(name, options, callback) {
  ...
  if (options == null || !options.strict) {
    try {
      const collection$1 = new collection(
        this,
        this.s.topology,
        this.databaseName,
        name,
      ...
      if (callback) callback(null, collection$1);
      return collection$1;
    } catch (err) {
