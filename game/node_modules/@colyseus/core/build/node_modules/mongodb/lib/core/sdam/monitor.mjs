...
import connect_1 from '../connection/connect.mjs';
import connection from '../../cmap/connection.mjs';
...
const makeInterruptableAsyncInterval = utils$1.makeInterruptableAsyncInterval;
const calculateDurationInMs = utils$1.calculateDurationInMs;
const now = utils$1.now;


const ServerHeartbeatStartedEvent = events.ServerHeartbeatStartedEvent;
const ServerHeartbeatSucceededEvent = events.ServerHeartbeatSucceededEvent;
const ServerHeartbeatFailedEvent = events.ServerHeartbeatFailedEvent;
...
class Monitor extends require$$0 {
  constructor(server, options) {
    super(options);

    this[kServer] = server;
    this[kConnection] = undefined;
    this[kCancellationToken] = new require$$0();
...
function checkServer(monitor, callback) {
  ...
  connect_1(monitor.connectOptions, monitor[kCancellationToken], (err, conn) => {
...
function measureRoundTripTime(rttPinger, options) {
  ...
  if (rttPinger[kConnection] == null) {
    connect_1(options, cancellationToken, (err, conn) => {
      if (err) {
