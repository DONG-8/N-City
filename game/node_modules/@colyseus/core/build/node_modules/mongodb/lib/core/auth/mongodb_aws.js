...
var mongo_credentials = require('./mongo_credentials.js');
var error = require('../error.js');
var crypto = require('crypto');
var http = require('http');
var utils = require('../utils.js');
var URL = require('url');
var aws4$1 = require('../../../../aws4/aws4.js');
...
const MongoCredentials = mongo_credentials.MongoCredentials;
...
class MongoDBAWS extends AuthProvider {
  auth(authContext, callback) {
    ...
    crypto__default['default'].randomBytes(32, (err, nonce) => {
      if (err) {
        callback(err);
        return;
      }
...
function request(uri, options, callback) {
  ...
  const req = http__default['default'].request(options, res => {
...
var mongodb_aws = MongoDBAWS;

module.exports = mongodb_aws;
