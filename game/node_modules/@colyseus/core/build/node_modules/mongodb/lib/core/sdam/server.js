...
var connection_pool = require('../../cmap/connection_pool.js');
...
const relayEvents = utils$1.relayEvents;
...
const collationNotSupported = utils$1.collationNotSupported;
const debugOptions = utils.debugOptions;
const isSDAMUnrecoverableError = error.isSDAMUnrecoverableError;
const isRetryableWriteError = error.isRetryableWriteError;
const isNodeShuttingDownError = error.isNodeShuttingDownError;
const isNetworkErrorBeforeHandshake = error.isNetworkErrorBeforeHandshake;
const maxWireVersion = utils$1.maxWireVersion;
const makeStateMachine = utils$1.makeStateMachine;
 ...
 */
class Server extends require$$0__default['default'] {
  /**
   * Create a server
   *
