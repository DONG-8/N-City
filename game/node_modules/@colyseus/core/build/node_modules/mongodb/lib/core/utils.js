...
const requireOptional = index(_commonjsHelpers.commonjsRequire);

/**
 * Generate a UUIDv4
 */
const uuidV4 = () => {
  const result = crypto__default['default'].randomBytes(16);
...
function makeClientMetadata(options) {
  ...
  const metadata = {
    ...
    os: {
      type: os__default['default'].type(),
      name: process.platform,
      architecture: process.arch,
      version: os__default['default'].release()
    },
    platform: `'Node.js ${process.version}, ${os__default['default'].endianness} (${
