...
function GridFSBucketWriteStream(bucket, filename, options) {
  options = options || {};
  Stream__default['default'].Writable.call(this, options);
  this.bucket = bucket;
  ...
  this.id = options.id ? options.id : index$1.BSON.ObjectId();
  this.chunkSizeBytes = this.options.chunkSizeBytes;
  this.bufToStore = Buffer.alloc(this.chunkSizeBytes);
  this.length = 0;
  this.md5 = !options.disableMD5 && crypto__default['default'].createHash('md5');
  this.n = 0;
  this.pos = 0;
  this.state = {
    streamEnd: false,
...
util__default['default'].inherits(GridFSBucketWriteStream, Stream__default['default'].Writable);
