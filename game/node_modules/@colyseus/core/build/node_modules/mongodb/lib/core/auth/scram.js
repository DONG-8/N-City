...
var index$1 = require('../../../../saslprep/index.js');
...
const emitWarningOnce = utils.emitWarning;
...
class ScramSHA extends AuthProvider {
  ...
  prepare(handshakeDoc, authContext, callback) {
    ...
    crypto__default['default'].randomBytes(24, (err, nonce) => {
      if (err) {
        return callback(err);
      }
...
function passwordDigest(username, password) {
  ...
  const md5 = crypto__default['default'].createHash('md5');
...
function HI(data, salt, iterations, cryptoMethod) {
  ...
  // generate the salt
  const saltedData = crypto__default['default'].pbkdf2Sync(
    data,
    salt,
    iterations,
...
function compareDigest(lhs, rhs) {
  ...
  if (typeof crypto__default['default'].timingSafeEqual === 'function') {
    return crypto__default['default'].timingSafeEqual(lhs, rhs);
  }
...
var scram = { ScramSHA1, ScramSHA256 };
