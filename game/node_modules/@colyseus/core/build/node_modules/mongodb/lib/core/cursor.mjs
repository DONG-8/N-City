...
import operation from '../operations/operation.mjs';
import async_iterator from '../async/async_iterator.mjs';
...
if (SUPPORTS.ASYNC_ITERATOR) {
  CoreCursor.prototype[Symbol.asyncIterator] = async_iterator.asyncIterator;
}
