...
class TopologyBase extends require$$0 {
  constructor() {
    super();
...
export default topology_base;
export { ServerCapabilities_1 as ServerCapabilities, Store_1 as Store, TopologyBase_1 as TopologyBase };
//# sourceMappingURL=topology_base.mjs.map
