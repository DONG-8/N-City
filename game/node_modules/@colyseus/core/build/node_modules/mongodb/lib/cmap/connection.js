...
var message_stream = require('./message_stream.js');
var error = require('../core/error.js');
var command_result = require('../core/connection/command_result.js');
var stream_description = require('./stream_description.js');
var index = require('../core/wireprotocol/index.js');
var apm = require('../core/connection/apm.js');
var sessions = require('../core/sessions.js');
var utils$1 = require('../core/utils.js');
...
class Connection extends require$$0__default['default'] {
  ...
  command(ns, cmd, options, callback) {
    index.command(makeServerTrampoline(this), ns, cmd, options, callback);
  }

  query(ns, cmd, cursorState, options, callback) {
    index.query(makeServerTrampoline(this), ns, cmd, cursorState, options, callback);
  }

  getMore(ns, cursorState, batchSize, options, callback) {
    index.getMore(makeServerTrampoline(this), ns, cursorState, batchSize, options, callback);
  }

  killCursors(ns, cursorState, callback) {
    index.killCursors(makeServerTrampoline(this), ns, cursorState, callback);
  }

  insert(ns, ops, options, callback) {
    index.insert(makeServerTrampoline(this), ns, ops, options, callback);
  }

  update(ns, ops, options, callback) {
    index.update(makeServerTrampoline(this), ns, ops, options, callback);
  }

  remove(ns, ops, options, callback) {
    index.remove(makeServerTrampoline(this), ns, ops, options, callback);
  }
}
