...
var utils = require('./core/connection/utils.js');
...
var mongodbClientEncryption__default = /*#__PURE__*/_interopDefaultLegacy(mongodbClientEncryption);
...
if (typeof mongodbClientEncryption__default['default'].extension !== 'function') {
  throw new MongoError(
...
const AutoEncrypter = mongodbClientEncryption__default['default'].extension(index).AutoEncrypter;
...
class Encrypter {
  ...
  getInternalClient(client) {
    if (!this[kInternalClient]) {
      ...
      this[kInternalClient] = new mongo_client(client.s.url, clonedOptions);
