...
var index = require('../../../../denque/index.js');
var require$$0 = require('events');
var server_description = require('./server_description.js');
var common = require('./common.js');
var topology_description = require('./topology_description.js');
var events = require('./events.js');
var server = require('./server.js');
var utils$2 = require('../utils.js');
var read_preference = require('../topologies/read_preference.js');
var shared = require('../topologies/shared.js');
var cursor = require('../cursor.js');
var util = require('util');
var utils = require('../connection/utils.js');
var sessions = require('../sessions.js');
var error = require('../error.js');
var srv_polling = require('./srv_polling.js');
var utils$1 = require('../../utils.js');
var events$1 = require('../../cmap/events.js');
var server_selection = require('./server_selection.js');
...
const ServerDescription = server_description.ServerDescription;
const ServerType = common.ServerType;
const TopologyDescription = topology_description.TopologyDescription;
const TopologyType = common.TopologyType;
...
const BSON = utils.retrieveBSON();
const createCompressionInfo = shared.createCompressionInfo;
const ClientSession = sessions.ClientSession;
const MongoError = error.MongoError;
const MongoServerSelectionError = error.MongoServerSelectionError;
const resolveClusterTime = shared.resolveClusterTime;
const SrvPoller = srv_polling['default'].SrvPoller;
const getMMAPError = shared.getMMAPError;
const makeStateMachine = utils$2.makeStateMachine;
const eachAsync = utils$2.eachAsync;
const emitDeprecationWarning = utils$1.emitDeprecationWarning;
const ServerSessionPool = sessions.ServerSessionPool;
const makeClientMetadata = utils$2.makeClientMetadata;
const CMAP_EVENT_NAMES = events$1.CMAP_EVENT_NAMES;
const compareTopologyVersion = server_description.compareTopologyVersion;
const emitWarning = utils$1.emitWarning;
...
const readPreferenceServerSelector = server_selection.readPreferenceServerSelector;
const writableServerSelector = server_selection.writableServerSelector;
 ...
 */
class Topology extends require$$0__default['default'] {
  /**
   * Create a topology
   *
  ...
  connect(options, callback) {
    ...
    read_preference.translate(options);
    const readPreference = options.readPreference || read_preference.primary;
    ...
    if (typeof options === 'function') {
      ...
      if (typeof selector !== 'function') {
        ...
        if (selector instanceof read_preference) {
          ...
          readPreference = new read_preference(selector);
        } else {
          read_preference.translate(options);
  ...
  endSessions(sessions, callback) {
    ...
    this.command(
      ...
      { readPreference: read_preference.primaryPreferred, noResponse: true },
      () => {
