...
import command_result from './command_result.mjs';
import shared from '../wireprotocol/shared.mjs';
import compression from '../wireprotocol/compression.mjs';
import apm from './apm.mjs';
import safeBuffer from '../../../../safe-buffer/index.mjs';
import connect_1 from './connect.mjs';
...
const MESSAGE_HEADER_SIZE = shared.MESSAGE_HEADER_SIZE;
const COMPRESSION_DETAILS_SIZE = shared.COMPRESSION_DETAILS_SIZE;
const opcodes = shared.opcodes;
const compress = compression.compress;
const compressorIDs = compression.compressorIDs;
const uncompressibleCommands = compression.uncompressibleCommands;

const Buffer = safeBuffer.Buffer;

const updateSessionFromResponse = sessions.updateSessionFromResponse;
const eachAsync = utils$1.eachAsync;
  ...
  return function(message, connection) {
    ...
    if (workItem && !workItem.immediateRelease) {
      ...
      handleOperationCallback(
        ...
        workItem.cb,
        null,
        new command_result(workItem.fullResult ? message : message.documents[0], connection, message)
      );
    }
  };
}
...
function createConnection(pool, callback) {
  ...
  connect_1(pool.options, pool.s.cancellationToken, (err, connection) => {
    pool.connectingConnections--;
