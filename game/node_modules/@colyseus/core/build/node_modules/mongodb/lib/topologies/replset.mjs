...
import topology_base from './topology_base.mjs';
import utils from '../utils.mjs';

const MongoError = core.MongoError;
const TopologyBase = topology_base.TopologyBase;
const Store = topology_base.Store;
const CReplSet = core.ReplSet;
const MAX_JS_INT = utils.MAX_JS_INT;
const translateOptions = utils.translateOptions;
