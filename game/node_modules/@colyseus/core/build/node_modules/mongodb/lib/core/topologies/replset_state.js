...
ReplSetState.prototype.pickServer = function(readPreference) {
  ...
  readPreference = readPreference || read_preference.primary;
  ...
  if (readPreference.equals(read_preference.secondary) && secondaries.length === 0) {
    return new MongoError('no secondary server available');
  }

  if (
    readPreference.equals(read_preference.secondaryPreferred) &&
  ...
  if (readPreference.equals(read_preference.primary) && this.primary == null) {
  ...
  if (
    readPreference.equals(read_preference.secondaryPreferred) ||
    readPreference.equals(read_preference.secondary)
  ) {
    ...
    if (readPreference.equals(read_preference.secondaryPreferred)) {
      return this.primary;
    }
  ...
  // Primary preferred
  if (readPreference.equals(read_preference.primaryPreferred)) {
    server = null;
...
var replset_state = ReplSetState;

module.exports = replset_state;
//# sourceMappingURL=replset_state.js.map
