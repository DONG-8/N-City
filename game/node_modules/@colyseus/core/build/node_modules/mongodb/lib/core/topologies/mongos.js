...
const retrieveBSON = utils.retrieveBSON;
...
Mongos.prototype.connect = function(options) {
  ...
  var servers = this.s.seedlist.map(function(x) {
    ...
    relayEvents(server$1, self, ['serverDescriptionChanged']);
    return server$1;
  });
...
function reconnectProxies(self, proxies, callback) {
  ...
  function execute(_server, i) {
    setTimeout(function() {
      ...
      // Emit opening server event
      self.emit('serverOpening', {
        topologyId: server$1.s.topologyId !== -1 ? server$1.s.topologyId : self.id,
        address: server$1.name
      });
      ...
      // Connect to proxy
      self.connectingProxies.push(server$1);
...
//# sourceMappingURL=mongos.js.map
