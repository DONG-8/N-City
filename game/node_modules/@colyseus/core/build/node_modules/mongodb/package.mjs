...
export default require$$1;
export { bugs, dependencies, description, devDependencies, engines, files, homepage, keywords, license, main, name, optionalDependencies, peerDependenciesMeta, repository, scripts, version };
