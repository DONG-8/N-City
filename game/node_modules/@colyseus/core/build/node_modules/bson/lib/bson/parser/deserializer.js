...
var Long = long['default'].Long,
  ...
  MinKey = min_key['default'].MinKey,
  MaxKey = max_key['default'].MaxKey,
  DBRef = db_ref['default'].DBRef,
  BSONRegExp = regexp['default'].BSONRegExp,
...
var deserializeObject = function(buffer, index, options, isArray) {
  ...
  while (!done) {
    ...
    if (elementType === BSON.BSON_DATA_STRING) {
      ...
      object[name] = new int_32['default'](
        buffer[index++] | (buffer[index++] << 8) | (buffer[index++] << 16) | (buffer[index++] << 24)
      );
      ...
      var decimal128$1 = new decimal128['default'](bytes);
