...
var deque = require('../double-ended-queue/js/deque.js');
var customErrors = require('./lib/customErrors.js');
var require$$0 = require('events');
var index = require('../redis-parser/index.js');
var index$1 = require('../redis-commands/index.js');
var debug = require('./lib/debug.js');
var createClient = require('./lib/createClient.js');
var multi = require('./lib/multi.js');
require('./lib/individualCommands.js');
require('./lib/extendedApi.js');
...
var redis = _commonjsHelpers.createCommonjsModule(function (module, exports) {
...
function RedisClient (options, stream) {
    ...
    if (stream) {
        ...
        cnx_options.family = (!options.family && net__default['default'].isIP(cnx_options.host)) || (options.family === 'IPv6' ? 6 : 4);
    ...
    this.command_queue = new deque(); // Holds sent commands to de-pipeline them
    this.offline_queue = new deque(); // Holds commands issued but not able to be sent
    this.pipeline_queue = new deque(); // Holds all pipelined commands
...
util__default['default'].inherits(RedisClient, EventEmitter);
...
RedisClient.prototype.create_stream = function () {
    ...
    if (this.options.stream) {
        ...
        if (this.options.tls) {
            this.stream = tls__default['default'].connect(this.connection_options);
        } else {
            this.stream = net__default['default'].createConnection(this.connection_options);
        }
    }
...
RedisClient.prototype.internal_send_command = function (command_obj) {
    ...
    if (this.options.prefix) {
        prefix_keys = index$1.getKeyIndexes(command, args_copy);
...
exports.RedisError = index['default'].RedisError;
exports.ParserError = index['default'].ParserError;
exports.ReplyError = index['default'].ReplyError;
...
exports.addCommand = exports.add_command = commands;
});
